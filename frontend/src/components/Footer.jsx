        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/campaigns" className="hover:text-blue-400 transition-colors duration-200">
                  Browse Campaigns
                </Link>
              </li>
              <li>
                <Link to="/campaigns/create" className="hover:text-blue-400 transition-colors duration-200">
                  Create Campaign
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/safety" className="hover:text-blue-400 transition-colors duration-200">
                  Safety & Security
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start space-x-3">
                ...
                <a href="mailto:support@careforall.org" className="hover:text-blue-400 transition-colors duration-200">
              ...
              <li className="flex items-start space-x-3">
                ...
                <span>123 Charity Street,<br />Helping City, HC 12345</span>
              </li>
            </ul>
          </div>
        </div>
